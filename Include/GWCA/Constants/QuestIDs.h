...
namespace GW {
    namespace Constants {
        namespace QuestID {
            ...
            namespace ZaishenMission {
                // Prophecies
                constexpr uint32_t The_Great_Northern_Wall = 936;
                constexpr uint32_t Fort_Ranik = 937;
                constexpr uint32_t Ruins_of_Surmia = 938;
                constexpr uint32_t Nolani_Academy = 939;
                constexpr uint32_t Borlis_Pass = 940;
                constexpr uint32_t The_Frost_Gate = 941;
                constexpr uint32_t Gates_of_Kryta = 942;
                constexpr uint32_t DAlessio_Seaboard = 943;
                constexpr uint32_t Divinity_Coast = 944;
                constexpr uint32_t The_Wilds = 945;
                constexpr uint32_t Bloodstone_Fen = 946;
                constexpr uint32_t Aurora_Glade = 947;
                constexpr uint32_t Riverside_Province = 948;
                constexpr uint32_t Sanctum_Cay = 949;
                constexpr uint32_t Dunes_of_Despair = 950;
                constexpr uint32_t Thirsty_River = 951;
                constexpr uint32_t Elona_Reach = 952;
                constexpr uint32_t Augury_Rock = 953;
                constexpr uint32_t The_Dragons_Lair = 954;
                constexpr uint32_t Ice_Caves_of_Sorrow = 955;
                constexpr uint32_t Iron_Mines_of_Moladune = 956;
                constexpr uint32_t Thunderhead_Keep = 957;
                constexpr uint32_t Ring_of_Fire = 958;
                constexpr uint32_t Abaddons_Mouth = 959;
                constexpr uint32_t Hells_Precipice = 960;

                // Factions
                constexpr uint32_t Minister_Chos_Estate = 1119;
                constexpr uint32_t Zen_Daijun = 961;
                constexpr uint32_t Vizunah_Square = 962;
                constexpr uint32_t Nahpui_Quarter = 963;
                constexpr uint32_t Tahnnakai_Temple = 964;
                constexpr uint32_t Arborstone = 965;
                ...
                constexpr uint32_t Raisu_Palace = 971;
                constexpr uint32_t Imperial_Sanctum = 972;

                // Nightfall
                constexpr uint32_t Chahbek_Village = 978;
                constexpr uint32_t Jokanur_Diggings = 979;
                constexpr uint32_t Blacktide_Den = 980;
                constexpr uint32_t Consulate_Docks = 981;
                constexpr uint32_t Venta_Cemetery = 982;
                constexpr uint32_t Kodonur_Crossroads = 983;
                constexpr uint32_t Pogahn_Passage = 1181;
                constexpr uint32_t Rilohn_Refuge = 984;
                constexpr uint32_t Moddok_Crevice = 985;
                constexpr uint32_t Tihark_Orchard = 986;
                constexpr uint32_t Dasha_Vestibule = 988;
                constexpr uint32_t Dzagonur_Bastion = 987;
                constexpr uint32_t Grand_Court_of_Sebelkeh = 989;
                constexpr uint32_t Jennurs_Horde = 990;
                constexpr uint32_t Nundu_Bay = 991;
                constexpr uint32_t Gate_of_Desolation = 992;
                constexpr uint32_t Ruins_of_Morah = 993;
                constexpr uint32_t Gate_of_Pain = 994;
                constexpr uint32_t Gate_of_Madness = 995;
                constexpr uint32_t Abaddons_Gate = 996;

                // Eye of the North
                constexpr uint32_t Finding_the_Bloodstone = 1000;
                constexpr uint32_t The_Elusive_Golemancer = 1001;
                constexpr uint32_t G_O_L_E_M = 1002;
                constexpr uint32_t Against_the_Charr = 1003;
                constexpr uint32_t Warband_of_Brothers = 1004;
                constexpr uint32_t Assault_on_the_Stronghold = 1005;
                constexpr uint32_t Curse_of_the_Nornbear = 1006;
                constexpr uint32_t Blood_Washes_Blood = 1007;
                constexpr uint32_t A_Gate_Too_Far = 1008;
                constexpr uint32_t Destructions_Depths = 1009;
                constexpr uint32_t A_Time_for_Heroes = 1010;
            }

            namespace ZaishenBounty {
                constexpr uint32_t Verata = 1016;
                constexpr uint32_t Rotscale = 1017;
                constexpr uint32_t The_Iron_Forgeman = 1019;
                constexpr uint32_t The_Darknesses = 1020;
                constexpr uint32_t Kepkhet_Marrowfeast = 1021;
                constexpr uint32_t Harn_And_Maxine_Coldstone = 1022;
                constexpr uint32_t Kanaxai = 1024;
                constexpr uint32_t Urgoz = 1025;
                constexpr uint32_t Chung_the_Attuned = 1026;
                constexpr uint32_t Royen_Beastkeeper = 1027;
                constexpr uint32_t Kunvie_Firewing = 1028;
                constexpr uint32_t Mungri_Magicbox = 1029;
                constexpr uint32_t Arbor_Earthcall = 1030;
                constexpr uint32_t Mohby_Windbeak = 1031;
                constexpr uint32_t Ssuns_Blessed_of_Dwayna = 1032;
                constexpr uint32_t Ghial_the_Bone_Dancer = 1033;
                constexpr uint32_t Quansong_Spiritspeak = 1034;
                constexpr uint32_t Baubao_Wavewrath = 1035;
                constexpr uint32_t Jarimiya_the_Unmerciful = 1036;
                constexpr uint32_t Commander_Wahli = 1037;
                constexpr uint32_t Droajam_Mage_of_the_Sands = 1038;
                constexpr uint32_t Jedeh_the_Mighty = 1039;
                constexpr uint32_t Korshek_the_Immolated = 1040;
                constexpr uint32_t Admiral_Kantoh = 1041;
                constexpr uint32_t Black_Beast_of_Arrgh = 1043;
                constexpr uint32_t Lord_Jadoth = 1044;
                constexpr uint32_t The_Stygian_Underlords = 1045;
                constexpr uint32_t The_Stygian_Lords = 1046;
                constexpr uint32_t The_Greater_Darkness = 1047;
                constexpr uint32_t Ilsundur_Lord_of_Fire = 1048;
                constexpr uint32_t Rragar_Maneater = 1049;
                constexpr uint32_t Murakai_Lady_of_the_Night = 1050;
                constexpr uint32_t Prismatic_Ooze = 1051;
                constexpr uint32_t Havok_Soulwail = 1052;
                constexpr uint32_t Frostmaw_the_Kinslayer = 1053;
                ...
                constexpr uint32_t Khabuus = 1057;
                constexpr uint32_t Zhim_Monns = 1058;
                constexpr uint32_t Eldritch_Ettin = 1059;
                constexpr uint32_t Fendi_Nin = 1060;
                constexpr uint32_t TPS_Regulator_Golem = 1061;
                constexpr uint32_t Arachni = 1062;
                constexpr uint32_t Forgewight = 1063;
                constexpr uint32_t Selvetarm = 1064;
                constexpr uint32_t Justiciar_Thommis = 1065;
                constexpr uint32_t Rand_Stormweaver = 1066;
                constexpr uint32_t Duncan_the_Black = 1067;
                constexpr uint32_t Fronis_Irontoe = 1068;
                constexpr uint32_t Magmus = 1070;
                constexpr uint32_t Molotov_Rocktail = 1071;
                constexpr uint32_t Nulfastu_Earthbound = 1072;
                constexpr uint32_t Pywatt_the_Swift = 1074;
                constexpr uint32_t Joffs_the_Mitigator = 1075;
                constexpr uint32_t Mobrin_Lord_of_the_Marsh = 1076;
                constexpr uint32_t Borrgus_Blisterbark = 1077;
                constexpr uint32_t Fozzy_Yeoryios = 1078;
                constexpr uint32_t Myish_Lady_of_the_Lake = 1079;
                constexpr uint32_t Fenrir = 1080;
                constexpr uint32_t Vengeful_Aatxe = 1081;
                constexpr uint32_t The_Four_Horsemen = 1082;
                constexpr uint32_t Charged_Blackness = 1083;
                constexpr uint32_t Dragon_Lich = 1084;
                constexpr uint32_t Priest_of_Menzies = 1085;
                constexpr uint32_t Lord_Khobay = 1086;
            }

            namespace ZaishenVanquish {
                constexpr uint32_t Witmans_Folly = 1193;
                constexpr uint32_t Arkjok_Ward = 1194;
                constexpr uint32_t Ascalon_Foothills = 1195;
                constexpr uint32_t Bahdok_Caverns = 1196;
                constexpr uint32_t Cursed_Lands = 1197;
                constexpr uint32_t Alcazia_Tangle = 1198;
                constexpr uint32_t Archipelagos = 1199;
                constexpr uint32_t Eastern_Frontier = 1200;
                ...
                constexpr uint32_t The_Sulfurous_Wastes = 1277;
                ...
                constexpr uint32_t Resplendent_Makuun = 1290;
                ...
                constexpr uint32_t Mount_Qinkai = 1316;
                constexpr uint32_t Marga_Coast = 1317;
                constexpr uint32_t Melandrus_Hope = 1318;
                constexpr uint32_t The_Falls = 1319;
                constexpr uint32_t Jokos_Domain = 1320;
                constexpr uint32_t Vulture_Drifts = 1321;
                constexpr uint32_t Wilderness_of_Bahdza = 1322;
                constexpr uint32_t Talmark_Wilderness = 1323;
                constexpr uint32_t Vehtendi_Valley = 1324;
                constexpr uint32_t Talus_Chute = 1325;
                constexpr uint32_t Mineral_Springs = 1326;
            }
        }
    }
}
