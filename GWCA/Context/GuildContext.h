...
namespace GW {
	...
	public:
		...
		void* unk5_ptr; // 18
		DWORD unk3; // 1c
		Array<void*> unk1_arr; // 20 - wierd fucking graph/binary tree i think
		DWORD unk4; // 30
		...
		DWORD unk7; // 2A0
		void* unk6_ptr; // 2A4
		Array<void*> unk2_arr; // 2A8
		Array<void*> unk3_arr; // 2B8
		DWORD unk8; //2C8
		GuildHistory playerguildhistory; // 2CC
		BYTE pad1[0x1C]; // 2DC
		GuildArray guilds; // 2F8
		DWORD unk9[4]; // 308
		Array<void*> unk4_arr; // 318 - some binary tree pointing to guilds
		DWORD unk10; // 328
		Array<void*> unk5_arr; // 32C
		BYTE pad2[0x1C]; // 33C
