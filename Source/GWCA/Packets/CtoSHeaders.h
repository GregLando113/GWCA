...
const unsigned short CtoGS_MSGCallSkill = 0x2C;
const unsigned short CtoGS_MSGSetSkillbarSkill = 0x62;
const unsigned short CtoGS_MSGChangeSecondary = 0x47;
const unsigned short CtoGS_MSGSetAttributes = 0x10;
const unsigned short CtoGS_MSGLoadSkillbar = 0x63; // TODO
...
const unsigned short CtoGS_MSGStartSalvage = 0x7D;
const unsigned short CtoGS_MSGSalvageMaterials = 0x80;
const unsigned short CtoGS_MSGSalvageMod = 0x81;
const unsigned short CtoGS_MSGIdentifyItem = 0x71;
const unsigned short CtoGS_MSGMoveItem = 0x78;
const unsigned short CtoGS_MSGAcceptAllItems = 0x79; // Untested
const unsigned short CtoGS_MSGUseItem = 0x84;
...
const unsigned short CtoGS_MSGAddNpc = 0xA6;
const unsigned short CtoGS_MSGKickNpc = 0xAF;
...
const unsigned short CtoGS_MSGEnterChallenge = 0xAC;
...
const unsigned short CtoGS_MSGTravelGH = 0xB7;
const unsigned short CtoGS_MSGTravelTo = 0xB8;
const unsigned short CtoGS_MSGLeaveGH = 0xB9;
const unsigned short CtoGS_MSGSendChat = 0x6A;
const unsigned short CtoGS_MSGSetDisplayedTitle = 0x5E;
const unsigned short CtoGS_MSGRemoveDisplayedTitle = 0x5F;
const unsigned short CtoGS_MSGSkipCinematic = 0x69;
const unsigned short CtoGS_MSGUnlockSkillByTome = 0x72;
const unsigned short CtoGS_MSGDeleteItem = 0x6E;
const unsigned short CtoGS_MSGSplitStack = 0x7B;
const unsigned short CtoGS_MSGChangeGold = 0x82;
const unsigned short CtoGS_MSGSwitchMode = 0xA2;
const unsigned short CtoGS_MSGLeaveParty = 0xA9;
const unsigned short CtoGS_MSGTick = 0xB6;
