...
#define GAME_CMSG_PING_REPLY                        (0x000A) // 10
#define GAME_CMSG_HEARTBEAT                         (0x000B) // 11
#define GAME_CMSG_PING_REQUEST                      (0x000C) // 12
#define GAME_CMSG_ATTRIBUTE_DECREASE                (0x000D) // 13
#define GAME_CMSG_ATTRIBUTE_INCREASE                (0x000E) // 14
#define GAME_CMSG_ATTRIBUTE_LOAD                    (0x000F) // 15
#define GAME_CMSG_QUEST_ABANDON                     (0x0010) // 16
#define GAME_CMSG_QUEST_REQUEST_INFOS               (0x0011) // 17
#define GAME_CMSG_HERO_BEHAVIOR                     (0x0014) // 20
#define GAME_CMSG_HERO_LOCK_TARGET                  (0x0015) // 21
#define GAME_CMSG_HERO_SKILL_TOGGLE                 (0x0018) // 24
#define GAME_CMSG_HERO_FLAG_SINGLE                  (0x0019) // 25
#define GAME_CMSG_HERO_FLAG_ALL                     (0x001A) // 26
#define GAME_CMSG_HERO_USE_SKILL                    (0x001B) // 27
#define GAME_CMSG_HERO_ADD                          (0x001D) // 29
#define GAME_CMSG_HERO_KICK                         (0x001E) // 30
#define GAME_CMSG_TARGET_CALL                       (0x0022) // 34
#define GAME_CMSG_PING_WEAPON_SET                   (0x0024) // 36
#define GAME_CMSG_ATTACK_AGENT                      (0x0025) // 37
#define GAME_CMSG_CANCEL_MOVEMENT                   (0x0027) // 39
#define GAME_CMSG_DROP_BUFF                         (0x0028) // 40
#define GAME_CMSG_DRAW_MAP                          (0x002A) // 42
#define GAME_CMSG_DROP_ITEM                         (0x002B) // 43
#define GAME_CMSG_DROP_GOLD                         (0x002E) // 46
#define GAME_CMSG_EQUIP_ITEM                        (0x002F) // 47
#define GAME_CMSG_INTERACT_PLAYER                   (0x0032) // 50
#define GAME_CMSG_DEPOSIT_FACTION                   (0x0034) // 52
#define GAME_CMSG_INTERACT_LIVING                   (0x0038) // 56
#define GAME_CMSG_SEND_DIALOG                       (0x003A) // 58
#define GAME_CMSG_MOVE_TO_COORD                     (0x003D) // 61
#define GAME_CMSG_INTERACT_ITEM                     (0x003E) // 62
#define GAME_CMSG_ROTATE_PLAYER                     (0x003F) // 63
#define GAME_CMSG_CHANGE_SECOND_PROFESSION          (0x0040) // 64
...
#define GAME_CMSG_INTERACT_GADGET                   (0x0050) // 80
#define GAME_CMSG_OPEN_CHEST                        (0x0052) // 82
#define GAME_CMSG_TITLE_DISPLAY                     (0x0057) // 87
#define GAME_CMSG_TITLE_HIDE                        (0x0058) // 88
#define GAME_CMSG_SKILLBAR_SKILL_SET                (0x005B) // 91
#define GAME_CMSG_SKILLBAR_LOAD                     (0x005C) // 92
#define GAME_CMSG_SKILLBAR_SKILL_REPLACE            (0x005D) // 93
#define GAME_CMSG_SKIP_CINEMATIC                    (0x0062) // 98
#define GAME_CMSG_SEND_CHAT_MESSAGE                 (0x0063) // 99
#define GAME_CMSG_ITEM_DESTROY                      (0x0068) // 104
#define GAME_CMSG_ITEM_IDENTIFY                     (0x006B) // 107
#define GAME_CMSG_TOME_UNLOCK_SKILL                 (0x006C) // 108
#define GAME_CMSG_ITEM_MOVE                         (0x0071) // 113
#define GAME_CMSG_ITEM_ACCEPT_ALL                   (0x0072) // 114
#define GAME_CMSG_ITEM_SPLIT_STACK                  (0x0074) // 116
#define GAME_CMSG_ITEM_SALVAGE_SESSION_OPEN         (0x0076) // 118
#define GAME_CMSG_ITEM_SALVAGE_SESSION_CANCEL       (0x0077) // 119
#define GAME_CMSG_ITEM_SALVAGE_SESSION_DONE         (0x0078) // 120
#define GAME_CMSG_ITEM_SALVAGE_MATERIALS            (0x0079) // 121
#define GAME_CMSG_ITEM_SALVAGE_UPGRADE              (0x007A) // 122
#define GAME_CMSG_ITEM_CHANGE_GOLD                  (0x007B) // 123
#define GAME_CMSG_ITEM_USE                          (0x007D) // 125
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_SPAWN       (0x0087) // 135
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_PLAYERS     (0x008F) // 143
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_ITEMS       (0x0090) // 144
#define GAME_CMSG_PARTY_SET_DIFFICULTY              (0x009A) // 154
#define GAME_CMSG_PARTY_ACCEPT_INVITE               (0x009B) // 155
#define GAME_CMSG_PARTY_ACCEPT_CANCEL               (0x009C) // 156
#define GAME_CMSG_PARTY_ACCEPT_REFUSE               (0x009D) // 157
#define GAME_CMSG_PARTY_INVITE_NPC                  (0x009E) // 158
#define GAME_CMSG_PARTY_INVITE_PLAYER               (0x009F) // 159
#define GAME_CMSG_PARTY_INVITE_PLAYER_NAME          (0x00A0) // 160
#define GAME_CMSG_PARTY_LEAVE_GROUP                 (0x00A1) // 161
#define GAME_CMSG_PARTY_CANCEL_ENTER_CHALLENGE      (0x00A2) // 162
...
#define GAME_CMSG_PARTY_SEARCH_REQUEST_REPLY        (0x00AC) // 172
#define GAME_CMSG_PARTY_SEARCH_TYPE                 (0x00AD) // 173
#define GAME_CMSG_PARTY_READY_STATUS                (0x00AE) // 174
