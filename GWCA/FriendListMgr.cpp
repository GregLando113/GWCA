...
GWAPI::FriendListMgr::FriendListMgr(GWAPIMgr& api) : GWCAManager(api)
{
	/*
	...
	*/
	...
	DWORD call = (DWORD)scanner.FindPattern("\x85\xC0\x74\x19\x6A\xFF\x8D\x50\x08\x8D\x4E\x08", "xxxxxxxxxxxx", -0x18);
